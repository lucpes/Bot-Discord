...
@bot.tree.command(name="painel_gerencia", description="Envia o painel de gerência com botões para ações de farms")
@check_cargo_permitido("Gerente")  # Certifique-se de que esse decorador já esteja implementado
async def painel_gerencia_cmd(interaction: Interaction):
